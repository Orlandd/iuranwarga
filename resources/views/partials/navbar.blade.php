{{-- Header --}}
<header
    class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white text-sm py-4 dark:bg-gray-800 shadow-md">
    <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
        ...
        <div id="navbar-image-1"
            ...
            <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                ...
                <hr>
                <div class="py-2">
                    <a href="/login" class="px-7 py-1 bg-gray-800 rounded-xl text-white">Login</a>
                </div>
            </div>
